...
But forget about storytelling, what about giving AI agency. [Meta][Meta] has already shown that AI can have the faculty to combine communication with strategic planning. Diplomacy, a strategically simplistic game, becomes highly complex when human interaction is added. Players can talk to, banter, work together and betray each other. Meta has managed to combine objective strategic planning and subjective interaction, in an AI that outperforms the vast majority of human players.
...
This ended up working fairly well, as you can see in the following images.
